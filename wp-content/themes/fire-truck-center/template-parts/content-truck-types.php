...
$current_term = is_tax( 'equipment_type' ) ? get_queried_object() : false;
	...
	<form class="truck-types__form" action="<?php echo esc_url( ftc_get_truck_catalog_url() ); ?>" method="get">
		<ul>
			<li>
				...
				<select class="truck-types__select" id="truck-types-select" aria-labelledby="truck-types-title">
					...
					<?php foreach ( $truck_types as $truck_type ) : ?>
						...
						?>
						<option value="<?php echo esc_url( $term_url ); ?>"<?php selected( $is_current ); ?>>
