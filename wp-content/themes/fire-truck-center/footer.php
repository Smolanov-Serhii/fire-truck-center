	...
	<footer class="footer">
		<div class="footer__container main-container">
            ...
            <div class="footer__nav">
                <div class="footer__nav-column">
                    ...
                    <ul class="footer__nav-list">
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Home</a></li>
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Contact us</a></li>
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Sell your truck</a></li>
                ...
                <div class="footer__nav-column">
                    ...
                    <ul class="footer__nav-list">
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Engine & Pumpers</a></li>
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Wildland & Brush trucks</a></li>
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Mini Pumpers</a></li>
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Aerials</a></li>
                        <li class="footer__nav-item"><a class="footer__nav-lnk" href="#">Rescues</a></li>
                    </ul>
                </div>
                <div class="footer__nav-column">
                    <div class="footer__nav-head">
                ...
                <div class="footer__nav-column">
                    ...
                    <ul class="footer__nav-list footer__nav-contacts">
                        <li class="footer__nav-item">
                            ...
                            <span>720 Cambria St. Suite #1 Portage PA 15946 United States</span>
                        </li>
                        <li class="footer__nav-item">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="footer__nav-lnk" href="tel:(610) 347-3878">
                                (610) 347-3878
                            </a>
                        </li>
                        <li class="footer__nav-item">
                            ...
                            <a class="footer__nav-lnk" href="mailto:help@firetruck.center">
            ...
            <div class="footer__copyright">
                Copyright © 2024 Fire Center   |   All rights reserved.
            </div>
		</div>
	</footer>
