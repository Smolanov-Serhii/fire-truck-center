                    ...
                    <div class="truck-single__wrapper swiper-wrapper">
                        <?php if( have_rows('image_slider') ): ?>
                            <?php while( have_rows('image_slider') ): the_row();
                                ...
                                $image_w = isset($image['sizes']['large-width']) ? intval($image['sizes']['large-width']) : 800;
                                $image_h = isset($image['sizes']['large-height']) ? intval($image['sizes']['large-height']) : 600;
                                if (wp_is_mobile()){
                                ...
                                <div class="truck-single__slide swiper-slide">
                                    ...
                                    <img src="<?php echo $image_small;?>" width="<?php echo $image_w;?>" height="<?php echo $image_h;?>" alt="<?php the_title();?>">
                                </div>
                            <?php endwhile; ?>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="truck-single__wrapper swiper-wrapper">
                        <?php if( have_rows('image_slider') ): ?>
                            <?php while( have_rows('image_slider') ): the_row();
                                ...
                                $thumb_w = isset($image['sizes']['medium-width']) ? intval($image['sizes']['medium-width']) : 300;
                                $thumb_h = isset($image['sizes']['medium-height']) ? intval($image['sizes']['medium-height']) : 225;
                                ?>
                                <div class="truck-single__slide swiper-slide">
                                    <img src="<?php echo $image_url;?>" width="<?php echo $thumb_w;?>" height="<?php echo $thumb_h;?>" alt="<?php the_title();?>">
                                </div>
                            <?php endwhile; ?>
                        <?php endif; ?>
                    </div>
